...
To [configure a database connector]({{"bonita/7.7/application-and-process-design/connectivity/database/database-connector-configuration" | relative_url}}), follow the instructions in the wizard.
