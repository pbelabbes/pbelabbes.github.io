...
| technicalPassword | This is the [password of the platform adminstrator]({{"bonita/7.7/installation/basic-bonita-platform-installation/first-steps-after-setup" | relative_url}}). | platform |
