...
To change style of your components in the HTML rendered reports, add CSS classes to them and update global Look'n'feel as described in [Bonita portal look'n'feel page]({{"bonita/7.7/bonita-portal-administration/look-feel/managing-look-feel" | relative_url}}).  
...
Once you have packaged the Jasper report as a ZIP archive, you can [install it in the Bonita Portal]({{"bonita/7.7/bonita-portal-administration/analytics" | relative_url}}).
