...
Note that the expression editor cannot be used in the UI Designer, which has a different concept model for [data]({{"bonita/7.7/application-and-process-design/page-and-form-development/ui-designer/variables" | relative_url}}).
...
You can [add logging]({{"bonita/7.7/development/logging" | relative_url}}) to Groovy scripts or Java code that you develop.
