...
It accounts for an additional step to ease the management of [Living Applications]({{"bonita/7.7/bonita-portal-administration/applications" | relative_url}}) in Bonita, since our objective is to offer a unique application deployment artifact, managed from the Studio.  
