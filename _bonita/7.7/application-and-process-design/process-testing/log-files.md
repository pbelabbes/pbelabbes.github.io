...
See the [Logging overview]({{"bonita/7.7/development/logging" | relative_url}}) for details of how logging is implemented in Bonita and how to add logging to Groovy scripts or Java code that you add to a process
