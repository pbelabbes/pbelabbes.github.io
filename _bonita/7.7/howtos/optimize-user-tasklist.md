...
{% alert info %}
**Note**: This howto applies to the legacy task list -Bonita 6.0 to 6.5.x versions- as well as the [new task list - from Bonita 7.3 and above]({{"bonita/7.7/bonita-portal-administration/bonita-portal-interface/user-task-list" | relative_url}}).
{% endalert %}
...
To do so, go to [word-based search]({{"bonita/7.7/development/engine-api/using-list-and-search-methods" | relative_url}}#word_based_search).
