...
Cache busting has been introduced in Bonita 7.6, along with a new [cache policy]({{"bonita/7.7/application-and-process-design/page-and-form-development/cache-configuration-and-policy" | relative_url}}).
