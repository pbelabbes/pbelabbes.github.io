...
1. Browse the file tree to `{{page.version}}.x/bonita-web/portal` folder.
...
1. For Subscription editions, you also need to get the files from `{{page.version}}.x/bonita-web-sp/portal` folder.
