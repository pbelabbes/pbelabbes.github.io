...
If you are using an LDAP service and the [LDAP synchronizer]({{"bonita/7.7/application-and-process-design/organization/ldap-synchronizer" | relative_url}}) to manage your user data,   
...
The recommended way to authenticate to Bonita Portal to use the REST API is to use the [login service]({{"bonita/7.7/development/rest-api/rest-api-overview" | relative_url}}#bonita-authentication)..
