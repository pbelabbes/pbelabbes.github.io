...
See also:  
[Install a Bonita cluster]({{"bonita/7.7/installation/advanced-bonita-platform-installation/bonita-in-a-cluster/install-a-bonita-bpm-cluster" | relative_url}})  
[Cluster administration]({{"bonita/7.7/installation/advanced-bonita-platform-installation/bonita-in-a-cluster/cluster-administration" | relative_url}})
...
The [Hibernate cache must be disabled]({{"bonita/7.7/installation/advanced-bonita-platform-installation/bonita-in-a-cluster/install-a-bonita-bpm-cluster" | relative_url}}#disable-hibernate-cache).
...
You can [migrate a process from 5.10]({{"bonita/7.7/application-and-process-design/process-modeling/diagrams/migrate-a-process-from-bonita-open-solution-5-x" | relative_url}}), but you need to build your Bonita cluster from scratch.
