...
7. Create [users with the standard profile]({{"bonita/7.5/bonita-bpm-portal-administration/organization-in-bonita-bpm-portal/organization-maintenance/manage-users/manage-a-user" | relative_url}}).
...
If you use an LDAP or Active Directory system, you can use the [LDAP synchronizer]({{"bonita/7.5/application-and-process-design/organization/ldap-synchronizer" | relative_url}}) tool to keep the Bonita BPM Portal organization synchronized with it.
