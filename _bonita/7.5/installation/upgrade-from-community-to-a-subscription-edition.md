...
1. [Install a Bonita BPM Studio]({{"bonita/7.5/installation/bonita-bpm-studio-installation" | relative_url}}) Subscription edition.
...
5. [Backup your Bonita BPM platform and databases]({{"bonita/7.5/installation/back-up-bonita-bpm-platform" | relative_url}}).
