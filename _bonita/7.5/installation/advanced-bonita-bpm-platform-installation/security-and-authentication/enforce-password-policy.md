...
To apply this policy edit [`security-config.properties`]({{"bonita/7.5/installation/basic-bonita-bpm-platform-installation/BonitaBPM_platform_setup" | relative_url}}) and change `DefaultPasswordValidator` to `RobustnessPasswordValidator`.
