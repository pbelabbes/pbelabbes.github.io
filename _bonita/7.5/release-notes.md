...
### Full Java 8 support
Bonita BPM is fully compatible with java 8 in production and development environment. It allows to write java 8 extension points (Connectors, Actor Filters, Custom Pages, ...). Java 8 syntax and specific APIs can now be fully used in all Bonita BPM [extensions points]({{"bonita/7.5/development/software-extensibility" | relative_url}}#stable_extension_points).
...
Refer to [full software requirements]({{"bonita/7.5/installation/basic-bonita-bpm-platform-installation/hardware-and-software-requirements" | relative_url}}) for more details on supported environments.
...
* Engine APIs have been cleaned up from some deprecated methods:
  * ProcessAPI.addComment() - replacement method is [ProcessAPI.addProcessComment()](http://documentation.bonitasoft.com/javadoc/api/{{page.version}}/org/bonitasoft/engine/api/ProcessRuntimeAPI.html#addProcessComment-long-java.lang.String-)
