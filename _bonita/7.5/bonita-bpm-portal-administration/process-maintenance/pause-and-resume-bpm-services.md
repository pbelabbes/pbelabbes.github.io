---
layout : doc
title : "Pause and resume BPM services"
version : "7.5"
categories:
...
The following sections explain how to pause and resume service in a tenant using Bonita BPM Portal. You can also use the [Engine API](http://documentation.bonitasoft.com/javadoc/api/{{page.version}}/index.html) or the [Web REST API]({{"bonita/7.5/development/rest-api/rest-api-overview" | relative_url}}).
