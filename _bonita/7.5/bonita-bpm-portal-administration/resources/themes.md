...
A theme is [exported, imported, modified, and deleted]({{"bonita/7.5/bonita-bpm-portal-administration/resources/resource-management" | relative_url}}) as a resource in Bonita BPM Portal. You specify the [theme for an application]({{"bonita/7.5/bonita-bpm-portal-administration/applications" | relative_url}}) in Bonita BPM Portal.
