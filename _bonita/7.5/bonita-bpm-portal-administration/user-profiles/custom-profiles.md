...
For deployment, it is also possible to [import a profile]({{"bonita/7.5/bonita-bpm-portal-administration/user-profiles/deploying-profiles-with-export-and-import" | relative_url}}) by importing an XML file containing the profile definition and mapping to organization and pages.
...
You can select from the Default pages that are provided with the standard portal and from [Custom pages]({{"bonita/7.5/bonita-bpm-portal-administration/resources/pages" | relative_url}}).
