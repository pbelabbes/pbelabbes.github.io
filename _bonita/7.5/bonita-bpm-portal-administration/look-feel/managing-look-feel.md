...
You can [create a new Look & Feel]({{"bonita/7.5/bonita-bpm-portal-administration/look-feel/creating-a-new-look-feel" | relative_url}}) for one of these items. When you have created the new Look & Feel, you apply it using Bonita BPM Portal, as follows:
...
1. Use the REST client to [log in]({{"bonita/7.5/development/rest-api/rest-api-overview" | relative_url}}) as a registered user of the Engine.
...
It is also possible to [restore the default Look & Feel using the Bonita BPM Engine API]({{"bonita/7.5/development/engine-api/examples/restore-default-look-feel" | relative_url}}).
