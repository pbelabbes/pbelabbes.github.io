---
layout : doc
title : "Organization management in Bonita BPM Studio"
version : "7.5"
categories:
...
* If you have a Subscription edition, use the [LDAP synchronizer]({{"bonita/7.5/application-and-process-design/organization/ldap-synchronizer" | relative_url}}) to automatically load information from your LDAP directory into Bonita BPM Engine. 
