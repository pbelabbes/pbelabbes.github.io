...
When testing is complete, the processes are ready to be deployed in Bonita BPM Portal and the application is ready to be put into production. You need to [configure]({{"bonita/7.5/application-and-process-design/process-configuration/process-configuration-overview" | relative_url}}) each process for deployment before putting it into production.
...
You can [manage your organization in Bonita BPM Portal]({{"bonita/7.5/bonita-bpm-portal-administration/organization-in-bonita-bpm-portal/organization-in-bonita-bpm-portal-overview" | relative_url}}) for a production system.   
While you are in the testing phase, you can [manage the organization in Bonita BPM Studio]({{"bonita/7.5/application-and-process-design/organization/organization-management-in-bonita-bpm-studio" | relative_url}}).
