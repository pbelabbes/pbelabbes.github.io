...
* Start form design in Bonita BPM Studio from the appropriate [contract]({{"bonita/7.5/application-and-process-design/data/contracts-and-contexts" | relative_url}}).
* Create [layouts]({{"bonita/7.5/bonita-bpm-portal-administration/resources/layouts" | relative_url}}) by duplicating the default layout available in the Bonita BPM Portal resources and then updating it.
...
In a row, you can add containers and [widgets]({{"bonita/7.5/application-and-process-design/page-and-form-development/ui-designer/widgets" | relative_url}}).  
...
There is a set of [standard widgets]({{"bonita/7.5/application-and-process-design/page-and-form-development/ui-designer/widgets" | relative_url}}). If these do not meet your needs, you can define a [custom widget]({{"bonita/7.5/application-and-process-design/page-and-form-development/ui-designer/custom-widgets" | relative_url}}).
...
In the Performance, Efficiency, and Teamwork editions, you can also use [fragments]({{"bonita/7.5/application-and-process-design/page-and-form-development/ui-designer/fragments" | relative_url}}), which are groups of widgets. They allow to reuse the same group of widgets with the same behavior in several pages or forms.
...
In the Subscription editions, you can [update a form in production]({{"bonita/7.5/bonita-bpm-portal-administration/live-update" | relative_url}}), by exporting a new version of the form from the Bonita BPM UI designer, importing it into the relevant process in the portal, and then mapping it to the relevant task or process start event. 
