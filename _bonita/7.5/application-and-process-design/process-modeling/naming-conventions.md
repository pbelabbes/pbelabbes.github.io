...
For information about to use variables in the UI Designer, go to [Variables]({{"bonita/7.5/application-and-process-design/page-and-form-development/ui-designer/variables" | relative_url}}).
