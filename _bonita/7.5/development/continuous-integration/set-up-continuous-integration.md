...
3. Configure Jenkins job:   
  ...
  See the BonitaStudioBuilder documentation for information on script options.  
...
2. [Configure local access]({{"bonita/7.5/development/engine-api/configure-client-of-bonita-bpm-engine" | relative_url}}) to Bonita BPM Engine.
3. As we want to test processes build with a Bonita BPM Subscription edition, you need to [configure the required Maven artifacts]({{"bonita/7.5/development/engine-api/create-your-first-project-with-the-engine-apis-and-maven" | relative_url}}). 
