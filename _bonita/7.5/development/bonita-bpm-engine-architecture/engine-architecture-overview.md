---
layout : doc
title : "Bonita BPM Engine architecture overview"
version : "7.5"
categories:
  - Development
...
The Bonita BPM Engine component services are completely configurable using the [plaform setup tool]({{"bonita/7.5/installation/basic-bonita-bpm-platform-installation/BonitaBPM_platform_setup" | relative_url}}) to retrieve the current configuration and update it.
...
Theses files can be retrieved and updated using the [platform setup tool]({{"bonita/7.5/installation/basic-bonita-bpm-platform-installation/BonitaBPM_platform_setup" | relative_url}}).
