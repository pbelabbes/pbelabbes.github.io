...
As explained in the [layouts]({{"bonita/7.5/bonita-bpm-portal-administration/resources/layouts" | relative_url}}) documentation page, it is possible to customize the existing application layout with the UI Designer.
