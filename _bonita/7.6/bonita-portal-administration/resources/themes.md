...
A theme is [exported, imported, modified, and deleted]({{"bonita/7.6/bonita-portal-administration/resources/resource-management" | relative_url}}) as a resource in Bonita Portal. You specify the [theme for an application]({{"bonita/7.6/bonita-portal-administration/applications" | relative_url}}) in Bonita Portal.
