...
You can also define]({{"bonita/7.6/application-and-process-design/reporting/reporting-overview" | relative_url}}) and . For example, you could define a report to track purchase order progress.
