...
To create a new Look & Feel in Bonita Portal, [export the default Look & Feel]({{"bonita/7.6/bonita-portal-administration/look-feel/managing-look-feel" | relative_url}}) and modify the relevant components. 
You can either edit the files directly, or you can use a plugin and update the Look & Feel in a browser. 
When the new Look & Feel is ready, [import and apply the new Look & Feel]({{"bonita/7.6/bonita-portal-administration/look-feel/managing-look-feel" | relative_url}}).
