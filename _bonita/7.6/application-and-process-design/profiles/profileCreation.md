...
+- [Living Applications]({{"bonita/7.6/bonita-portal-administration/applications" | relative_url}})
...
(When used to access a Living Application, the application menu is defined in the [application descriptor]({{"bonita/7.6/application-and-process-design/applicationCreation" | relative_url}}) itself.)  
...
To map a new application to this profile, you have to open the application and then choose this profile in the profile field of the [application descriptor editor]({{"bonita/7.6/application-and-process-design/applicationCreation" | relative_url}})
