...
Bonita contains a set of standard connectors. You can also create custom connectors using the [connector development toolkit]({{"bonita/7.6/development/bonita-artifacts/connectors/connector-development-toolkit" | relative_url}}).
