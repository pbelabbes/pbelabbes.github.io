...
Before you deploy a process, you need to [map the process actors]({{"bonita/7.6/application-and-process-design/process-modeling/actors" | relative_url}}). This mapping defines who can carry out steps in the process. 
...
This [custom information is defined in Bonita Studio]({{"bonita/7.6/application-and-process-design/organization/custom-user-information-in-bonita-bpm-studio" | relative_url}}), then applied to an actor filter, and when deployed in Bonita Portal, enables the filtering of users mapped to tasks.
...
See [custom user information in Bonita Studio]({{"bonita/7.6/application-and-process-design/organization/custom-user-information-in-bonita-bpm-studio" | relative_url}}) for setting the definition and values for the filter

### In Bonita Portal:

This custom information can only be seen and [edited]({{"bonita/7.6/bonita-portal-administration/organization-in-bonita-portal/organization-maintenance/custom-user-information-in-bonita-bpm-portal" | relative_url}}) by users who have the Administrator profile.
