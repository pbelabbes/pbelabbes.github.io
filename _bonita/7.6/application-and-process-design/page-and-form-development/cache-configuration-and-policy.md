...
see [Cache configuration]({{"bonita/7.6/installation/bonita-bpm-studio-installation" | relative_url}}#enable_cache) documentation.
...
As the pages generated by the UI Designer take advantage of a [cache busting]({{"bonita/7.6/bonita-portal-administration/live-update" | relative_url}}#cache_busting) mechanism, we can set the 
