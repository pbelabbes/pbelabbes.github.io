...
By default, a container contains one row, where you can drop component widgets or containers. You can also make the page layout dynamic by [repeating a container to display a collection of data]({{"bonita/7.6/application-and-process-design/page-and-form-development/ui-designer/widget-use-examples/repeat-a-container-for-a-collection-of-data" | relative_url}}).
...
For a detailed example using the Date picker widget, you can consult the following Howto: [Manage dates and times in BDM and User Interfaces]({{"bonita/7.6/howtos/datetimes-management-tutorial" | relative_url}}).
...
For a detailed example using the Date time picker widget, you can consult the following Howto: [Manage dates and times in BDM and User Interfaces]({{"bonita/7.6/howtos/datetimes-management-tutorial" | relative_url}}).
...
Supported parameters are described in the [REST API Overview]({{"bonita/7.6/development/rest-api/rest-api-overview" | relative_url}}) and in the REST API documentation for the relevant resource.  
...
A options toolbar exposed to end users can be customized and localized with the usual [localization mechanism]({{"bonita/7.6/application-and-process-design/page-and-form-development/ui-designer/multi-language-pages" | relative_url}}) (localization.json file).
