...
To apply this policy edit [`security-config.properties`]({{"bonita/7.6/installation/basic-bonita-platform-installation/BonitaBPM_platform_setup" | relative_url}}) and change `DefaultPasswordValidator` to `RobustnessPasswordValidator`.
