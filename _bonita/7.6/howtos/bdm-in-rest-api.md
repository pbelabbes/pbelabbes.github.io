...
This page demonstrates best practices when developing a [REST API Extension]({{"bonita/7.6/development/rest-api/rest-api-extensions" | relative_url}}) accessing [Business Data]({{"bonita/7.6/application-and-process-design/data/define-and-deploy-the-bdm" | relative_url}}).  
...
Note that the relationships from car to wheel1, wheel2, wheel3, wheel4 are **[lazy]({{"bonita/7.6/application-and-process-design/data/define-and-deploy-the-bdm" | relative_url}}#lazy_eager_loading) loaded** (in the Studio, it is
...
* If lazy loaded objects should always be returned in the response, consider changing the relation from ['lazy' to 'eager']({{"bonita/7.6/application-and-process-design/data/define-and-deploy-the-bdm" | relative_url}}#lazy_eager_loading)
in the model.
{% endalert %}
