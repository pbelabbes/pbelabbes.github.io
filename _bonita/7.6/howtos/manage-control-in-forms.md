...
_Note_: A tutorial about [creating modal windows using CSS in the UI Designer]({{"bonita/7.6/howtos/uid-modal-tutorial" | relative_url}}) is available. We recommend to read it before you go further in this tutorial.
