...
2. [Configure local access]({{"bonita/7.6/development/engine-api/configure-client-of-bonita-bpm-engine" | relative_url}}) to Bonita Engine.
3. As we want to test processes build with a Bonita Subscription edition, you need to [configure the required Maven artifacts]({{"bonita/7.6/development/engine-api/create-your-first-project-with-the-engine-apis-and-maven" | relative_url}}). 
