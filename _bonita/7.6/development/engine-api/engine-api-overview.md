...
There is also a high-level [Web REST API]({{"bonita/7.6/development/rest-api/rest-api-overview" | relative_url}}), intended for customers developing portal applications.
