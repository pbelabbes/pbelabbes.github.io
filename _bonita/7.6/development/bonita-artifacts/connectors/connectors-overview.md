...
In the Bonita Performance, Efficiency, and Teamwork editions, you are recommended to use the [connector development toolkit]({{"bonita/7.6/development/bonita-artifacts/connectors/connector-development-toolkit" | relative_url}}) to create new connectors.
...
After deployment, if you are running the Performance edition, you can [update the connector implementation on a live system]({{"bonita/7.6/bonita-portal-administration/live-update" | relative_url}}).
