...
Further configuration instructions for **AWS single sign-on** can be found [on this page]({{"bcd/2.0/howtos/manage-bonita-stacks/aws_sso" | relative_url}}).
...
1. [Create an IAM Group](http://docs.aws.amazon.com/IAM/latest/UserGuide/id_groups_create.html)
    ...
    *For some usage you may be interested to create a role and attach to it the corresponding policies, see [Configure AWS single sign-on]({{"bcd/2.0/howtos/manage-bonita-stacks/aws_sso" | relative_url}}) or [Assume IAM role within AWS Organizations]({{"bcd/2.0/howtos/manage-bonita-stacks/aws_organizations" | relative_url}}).*
