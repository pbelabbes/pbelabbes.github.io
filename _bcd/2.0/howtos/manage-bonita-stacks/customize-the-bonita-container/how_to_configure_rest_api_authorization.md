...
Since 2.0.x, BCD manages the REST_API_DYN_AUTH_CHECKS environment through the [scenario variable]({{"bcd/2.0/bcd-services-and-scenarios/scenarios" | relative_url}}) `bonita_rest_api_dyn_auth_checks`.  
