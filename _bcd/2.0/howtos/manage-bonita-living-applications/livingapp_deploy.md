...
{% alert info %}
Refer to the [BCD Command-line reference]({{"bcd/2.0/bcd-services-and-scenarios/bcd_cli" | relative_url}}) for a complete list of available options for the `bcd livingapp deploy` command.
{% endalert %}
