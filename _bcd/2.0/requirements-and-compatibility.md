...
- **Control host** - the host where your [BCD controller]({{"bcd/2.0/bcd-services-and-scenarios/bcd_controller" | relative_url}}) will run.
...
This compatibility information is also specified in the [Release notes]({{"bcd/2.0/release_notes" | relative_url}}) for each version of BCD.
